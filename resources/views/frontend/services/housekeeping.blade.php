...
@section('title', 'Housekeeping Services - MVG Jobs')

@section('content')
<!-- start page title -->
<section class="page-title-big-typography bg-dark-gray ipad-top-space-margin" data-parallax-background-ratio="0.5" style="background-image: url({{ asset('images/housekeeping.png') }})">
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 md-mb-40px">
                <figure class="position-relative m-0">
                    <img src="{{ asset('images/housekeeping.png') }}" alt="Housekeeping Services" class="w-100 border-radius-5px">
            ...
            <div class="col-xl-5 offset-xl-1 col-lg-6 col-md-10 text-center text-lg-start">
                <span class="bg-solitude-blue text-uppercase fs-13 ps-25px pe-25px alt-font fw-600 text-base-color lh-40 sm-lh-55 border-radius-100px d-inline-block mb-25px">Facilities Management</span>
                <h3 class="fw-600 text-dark-gray mb-20px ls-minus-2px alt-font">Professional housekeeping for clean and well-maintained premises.</h3>
                <p class="w-95 md-w-100 mb-35px">We provide comprehensive housekeeping services using modern equipment and trained, uniformed staff for offices, hospitals, hotels, factories, and residential complexes. Our housekeeping solutions ensure a clean, hygienic, and well-maintained environment every day.</p>
                <div class="pt-20px pb-20px ps-30px pe-30px xs-p-15px border border-color-extra-medium-gray border-radius-6px mb-15px icon-with-text-style-08 w-90 lg-w-100">
                    <div class="feature-box feature-box-left-icon-middle d-inline-flex align-middle">
                        ...
                        <div class="feature-box-content">
                            <span class="alt-font fw-600 text-dark-gray d-block lh-26">Uniformed housekeeping professionals.</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 justify-content-center">
            <div class="col icon-with-text-style-04 transition-inner-all md-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-14 pe-14 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    ...
                    <div class="feature-box-content">
                        <span class="d-inline-block alt-font text-dark-gray fw-500 fs-18 mb-5px">Quality Audits</span>
                        <p class="text-light-opacity">Regular performance monitoring.</p>
                    </div>
            ...
            <div class="col icon-with-text-style-04 transition-inner-all md-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-14 pe-14 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    ...
                    <div class="feature-box-content">
                        <span class="d-inline-block alt-font text-dark-gray fw-500 fs-18 mb-5px">Sanitization</span>
                        <p class="text-light-opacity">Regular disinfection protocols.</p>
                    </div>
                    <div class="feature-box-overlay bg-base-color"></div>
                </div>
            </div>
            <div class="col icon-with-text-style-04 transition-inner-all xs-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-14 pe-14 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    <div class="feature-box-icon">
                        <i class="ti-loop text-base-color icon-extra-large text-light-opacity mb-20px"></i>
                    </div>
                    <div class="feature-box-content">
                        <span class="d-inline-block alt-font text-dark-gray fw-500 fs-18 mb-5px">Scheduled</span>
                        <p class="text-light-opacity">Daily, weekly, and monthly.</p>
                    </div>
                    <div class="feature-box-overlay bg-base-color"></div>
                </div>
            </div>
            <div class="col icon-with-text-style-04 transition-inner-all">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-14 pe-14 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    ...
                    <div class="feature-box-content">
                        <span class="d-inline-block alt-font text-dark-gray fw-500 fs-18 mb-5px">Supervised</span>
                        <p class="text-light-opacity">Dedicated on-site supervision.</p>
                    </div>
                    <div class="feature-box-overlay bg-base-color"></div>
                </div>
            </div>
        ...
        <div class="row row-cols-1 row-cols-lg-3 row-cols-sm-2 align-items-center justify-content-center mt-6 xs-mt-8">
            <div class="col border-end xs-border-end-0 border-color-transparent-dark-very-light md-mb-35px">
                <div class="d-flex align-items-center justify-content-center">
                    <div class="flex-shrink-0 me-25px sm-me-15px">
                        <h2 class="mb-0 text-dark-gray fw-700 ls-minus-2px">4.96</h2>
                    </div>
            ...
            <div class="col">
                <div class="d-flex align-items-center justify-content-center">
                    <div class="flex-shrink-0 me-25px sm-me-15px">
                        <h2 class="mb-0 text-dark-gray fw-700 ls-minus-2px">400<sup class="fs-30">+</sup></h2>
                    </div>
                    <div class="text-dark-gray">
                        <span class="fs-17 lh-26 d-block fw-500">Premises managed monthly.</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center mb-7 sm-mb-40px">
            <div class="col-xl-5 col-lg-6 col-md-10 md-mb-50px">
                ...
                <h3 class="fw-600 text-dark-gray ls-minus-2px alt-font">Benefits of our Housekeeping Services.</h3>
                <div class="icon-with-text-style-08 mb-10px">
                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                        ...
                        <div class="feature-box-content">
                            <span class="text-dark-gray">400+ premises managed with our housekeeping teams monthly.</span>
                        </div>
                    </div>
                </div>
                <div class="icon-with-text-style-08 mb-10px">
                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                        ...
                        <div class="feature-box-content">
                            <span class="text-dark-gray">Daily housekeeping routines using modern equipment.</span>
                        </div>
                    </div>
                </div>
                <div class="icon-with-text-style-08">
                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                        ...
                        <div class="feature-box-content">
                            <span class="text-dark-gray">Trained, uniformed, and supervised housekeeping staff.</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="atropos-scale">
                        <div class="atropos-rotate">
                            <div class="atropos-inner">
                                <img src="{{ asset('images/housekeeping.png') }}" alt="Housekeeping Services" class="border-radius-6px" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center mt-8 sm-mt-40px">
            <div class="col-12">
                <div class="bg-solitude-blue p-9 md-p-6 xs-p-9 border-radius-6px overflow-hidden position-relative">
                    ...
                    <div class="accordion accordion-style-02" id="accordion-housekeeping" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                        <div class="accordion-item active-accordion">
                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#acc-housekeeping-01" aria-expanded="true" data-bs-parent="#accordion-housekeeping" aria-label="accordion">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                        <i class="feather icon-feather-minus fs-20"></i><span class="fw-500">What housekeeping services are included?</span>
                                    </div>
                                </a>
                            </div>
                            <div id="acc-housekeeping-01" class="accordion-collapse collapse show" data-bs-parent="#accordion-housekeeping">
                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                    <p class="w-90 sm-w-95 xs-w-100">Our housekeeping services include daily office cleaning, washroom maintenance, waste management, floor cleaning and polishing, dusting, glass cleaning, and common area upkeep on daily, weekly, and monthly schedules.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#acc-housekeeping-02" aria-expanded="false" data-bs-parent="#accordion-housekeeping" aria-label="accordion">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                        <i class="feather icon-feather-plus fs-20"></i><span class="fw-500">Do you provide housekeeping for residential complexes?</span>
                                    </div>
                                </a>
                            </div>
                            <div id="acc-housekeeping-02" class="accordion-collapse collapse" data-bs-parent="#accordion-housekeeping">
                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                    <p class="w-90 sm-w-95 xs-w-100">Yes, we provide full-time, part-time, and contract housekeeping staff for residential societies, apartment complexes, bungalows, and gated communities across Maharashtra.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div class="accordion-header border-bottom border-color-transparent">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#acc-housekeeping-03" aria-expanded="false" data-bs-parent="#accordion-housekeeping" aria-label="accordion">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                        <i class="feather icon-feather-plus fs-20"></i><span class="fw-500">Can we customize the housekeeping schedule?</span>
                                    </div>
                                </a>
                            </div>
                            <div id="acc-housekeeping-03" class="accordion-collapse collapse" data-bs-parent="#accordion-housekeeping">
                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent">
                                    <p class="w-90 sm-w-95 xs-w-100">Absolutely. We create tailored housekeeping schedules and detailed task checklists based on the specific size, usage, and requirements of your facility.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center text-center text-md-start">
            <div class="col sm-mb-20px">
                <h4 class="alt-font text-dark-gray fw-600 ls-minus-2px m-0">Get a free consultation for Housekeeping Services?</h4>
            </div>
