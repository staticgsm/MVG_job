...
@section('title', 'Catering Services - MVG Jobs')

@section('content')
<!-- start page title -->
<section class="page-title-big-typography bg-dark-gray ipad-top-space-margin" data-parallax-background-ratio="0.5" style="background-image: url({{ asset('images/catering.png') }})">
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 md-mb-40px">
                <figure class="position-relative m-0">
                    <img src="{{ asset('images/catering.png') }}" alt="Catering Services" class="w-100 border-radius-5px">
            ...
            <div class="col-xl-5 offset-xl-1 col-lg-6 col-md-10 text-center text-lg-start">
                <span class="bg-solitude-blue text-uppercase fs-13 ps-25px pe-25px alt-font fw-600 text-base-color lh-40 sm-lh-55 border-radius-100px d-inline-block mb-25px">Food & Hospitality</span>
                <h3 class="fw-600 text-dark-gray mb-20px ls-minus-2px alt-font">Hygienic and quality catering for corporate setups.</h3>
                <p class="w-95 md-w-100 mb-35px">We provide professional catering services for corporate offices, industrial canteens, and institutional facilities. Our experienced culinary team ensures fresh, nutritious, and hygienic meals are served on time every day.</p>
                <div class="pt-20px pb-20px ps-30px pe-30px xs-p-15px border border-color-extra-medium-gray border-radius-6px mb-15px icon-with-text-style-08 w-90 lg-w-100">
                    <div class="feature-box feature-box-left-icon-middle d-inline-flex align-middle">
                        ...
                        <div class="feature-box-content">
                            <span class="alt-font fw-600 text-dark-gray d-block lh-26">FSSAI-compliant food handling.</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 justify-content-center">
            <div class="col icon-with-text-style-04 transition-inner-all md-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-14 pe-14 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    ...
                    <div class="feature-box-content">
                        <span class="d-inline-block alt-font text-dark-gray fw-500 fs-18 mb-5px">On-Time</span>
                        <p class="text-light-opacity">Punctual meal delivery every day.</p>
                    </div>
            ...
            <div class="col icon-with-text-style-04 transition-inner-all md-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-14 pe-14 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    ...
                    <div class="feature-box-content">
                        <span class="d-inline-block alt-font text-dark-gray fw-500 fs-18 mb-5px">Expert Chefs</span>
                        <p class="text-light-opacity">Trained and experienced culinary team.</p>
                    </div>
                    <div class="feature-box-overlay bg-base-color"></div>
                </div>
            </div>
            <div class="col icon-with-text-style-04 transition-inner-all xs-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-14 pe-14 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    <div class="feature-box-icon">
                        <i class="ti-cup text-base-color icon-extra-large text-light-opacity mb-20px"></i>
                    </div>
                    <div class="feature-box-content">
                        <span class="d-inline-block alt-font text-dark-gray fw-500 fs-18 mb-5px">Fresh Food</span>
                        <p class="text-light-opacity">Farm-fresh ingredients daily.</p>
                    </div>
                    <div class="feature-box-overlay bg-base-color"></div>
                </div>
            </div>
            <div class="col icon-with-text-style-04 transition-inner-all">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-14 pe-14 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    ...
                    <div class="feature-box-content">
                        <span class="d-inline-block alt-font text-dark-gray fw-500 fs-18 mb-5px">Hygiene First</span>
                        <p class="text-light-opacity">Strict hygiene and sanitation standards.</p>
                    </div>
                    <div class="feature-box-overlay bg-base-color"></div>
                </div>
            </div>
        ...
        <div class="row row-cols-1 row-cols-lg-3 row-cols-sm-2 align-items-center justify-content-center mt-6 xs-mt-8">
            ...
            <div class="col">
                <div class="d-flex align-items-center justify-content-center">
                    <div class="flex-shrink-0 me-25px sm-me-15px">
                        <h2 class="mb-0 text-dark-gray fw-700 ls-minus-2px">150<sup class="fs-30">+</sup></h2>
                    </div>
                    <div class="text-dark-gray">
                        <span class="fs-17 lh-26 d-block fw-500">Clients served daily.</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center mb-7 sm-mb-40px">
            <div class="col-xl-5 col-lg-6 col-md-10 md-mb-50px">
                ...
                <h3 class="fw-600 text-dark-gray ls-minus-2px alt-font">Benefits of our Catering Services.</h3>
                <div class="icon-with-text-style-08 mb-10px">
                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                        ...
                        <div class="feature-box-content">
                            <span class="text-dark-gray">150+ corporate clients served daily across Maharashtra.</span>
                        </div>
                    </div>
                </div>
                <div class="icon-with-text-style-08 mb-10px">
                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                        ...
                        <div class="feature-box-content">
                            <span class="text-dark-gray">Customized menu solutions for every dietary need.</span>
                        </div>
                    </div>
                </div>
                <div class="icon-with-text-style-08">
                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                        ...
                        <div class="feature-box-content">
                            <span class="text-dark-gray">Strict hygiene and food safety standards maintained.</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="atropos-scale">
                        <div class="atropos-rotate">
                            <div class="atropos-inner">
                                <img src="{{ asset('images/catering.png') }}" alt="Catering Services" class="border-radius-6px" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center mt-8 sm-mt-40px">
            <div class="col-12">
                <div class="bg-solitude-blue p-9 md-p-6 xs-p-9 border-radius-6px overflow-hidden position-relative">
                    ...
                    <div class="accordion accordion-style-02" id="accordion-catering" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                        <div class="accordion-item active-accordion">
                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#acc-catering-01" aria-expanded="true" data-bs-parent="#accordion-catering" aria-label="accordion">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                        <i class="feather icon-feather-minus fs-20"></i><span class="fw-500">What types of catering services do you offer?</span>
                                    </div>
                                </a>
                            </div>
                            <div id="acc-catering-01" class="accordion-collapse collapse show" data-bs-parent="#accordion-catering">
                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                    <p class="w-90 sm-w-95 xs-w-100">We offer industrial canteen management, corporate cafeteria services, packed lunch delivery, and event catering. We handle everything from menu planning to daily operations.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#acc-catering-02" aria-expanded="false" data-bs-parent="#accordion-catering" aria-label="accordion">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                        <i class="feather icon-feather-plus fs-20"></i><span class="fw-500">Do you accommodate special dietary requirements?</span>
                                    </div>
                                </a>
                            </div>
                            <div id="acc-catering-02" class="accordion-collapse collapse" data-bs-parent="#accordion-catering">
                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                    <p class="w-90 sm-w-95 xs-w-100">Yes, we customize menus to accommodate vegetarian, vegan, diabetic-friendly, and allergy-sensitive dietary needs for all your employees.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div class="accordion-header border-bottom border-color-transparent">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#acc-catering-03" aria-expanded="false" data-bs-parent="#accordion-catering" aria-label="accordion">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                        <i class="feather icon-feather-plus fs-20"></i><span class="fw-500">Can you manage high-volume daily meals?</span>
                                    </div>
                                </a>
                            </div>
                            <div id="acc-catering-03" class="accordion-collapse collapse" data-bs-parent="#accordion-catering">
                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent">
                                    <p class="w-90 sm-w-95 xs-w-100">Absolutely. We are equipped to handle large-scale operations, serving thousands of meals per day across multiple shifts in industrial and corporate facilities.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center text-center text-md-start">
            <div class="col sm-mb-20px">
                <h4 class="alt-font text-dark-gray fw-600 ls-minus-2px m-0">Get a free consultation for Catering Services?</h4>
            </div>
