...
@section('title', 'Civil Works - MVG Jobs')

@section('content')
<!-- start page title -->
<section class="page-title-big-typography bg-dark-gray ipad-top-space-margin" data-parallax-background-ratio="0.5" style="background-image: url({{ asset('images/civilwork.png') }})">
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 md-mb-40px">
                <figure class="position-relative m-0">
                    <img src="{{ asset('images/civilwork.png') }}" alt="Civil Works" class="w-100 border-radius-5px">
            ...
            <div class="col-xl-5 offset-xl-1 col-lg-6 col-md-10 text-center text-lg-start">
                <span class="bg-solitude-blue text-uppercase fs-13 ps-25px pe-25px alt-font fw-600 text-base-color lh-40 sm-lh-55 border-radius-100px d-inline-block mb-25px">Construction & Infrastructure</span>
                <h3 class="fw-600 text-dark-gray mb-20px ls-minus-2px alt-font">Reliable civil construction and maintenance across Maharashtra.</h3>
                <p class="w-95 md-w-100 mb-35px">We execute reliable civil construction, repair, and maintenance projects for corporate, industrial, and government clients throughout Maharashtra. From new construction to renovation, our experienced teams deliver quality results on time and within budget.</p>
                <div class="pt-20px pb-20px ps-30px pe-30px xs-p-15px border border-color-extra-medium-gray border-radius-6px mb-15px icon-with-text-style-08 w-90 lg-w-100">
                    <div class="feature-box feature-box-left-icon-middle d-inline-flex align-middle">
                        <div class="feature-box-icon me-10px">
                            <i class="feather icon-feather-tool icon-medium text-base-color"></i>
                        </div>
                        <div class="feature-box-content">
                            <span class="alt-font fw-600 text-dark-gray d-block lh-26">Civil repair and maintenance.</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 justify-content-center">
            <div class="col icon-with-text-style-04 transition-inner-all md-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-14 pe-14 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    <div class="feature-box-icon">
                        <i class="ti-layers text-base-color icon-extra-large text-light-opacity mb-20px"></i>
                    </div>
                    <div class="feature-box-content">
                        <span class="d-inline-block alt-font text-dark-gray fw-500 fs-18 mb-5px">Retrofitting</span>
                        <p class="text-light-opacity">Structural upgrades and retrofits.</p>
                    </div>
            ...
            <div class="col icon-with-text-style-04 transition-inner-all md-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-14 pe-14 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    ...
                    <div class="feature-box-content">
                        <span class="d-inline-block alt-font text-dark-gray fw-500 fs-18 mb-5px">Pan-Maharashtra</span>
                        <p class="text-light-opacity">Project execution statewide.</p>
                    </div>
                    <div class="feature-box-overlay bg-base-color"></div>
                </div>
            </div>
            <div class="col icon-with-text-style-04 transition-inner-all xs-mb-30px">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-14 pe-14 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    <div class="feature-box-icon">
                        <i class="ti-home text-base-color icon-extra-large text-light-opacity mb-20px"></i>
                    </div>
                    <div class="feature-box-content">
                        <span class="d-inline-block alt-font text-dark-gray fw-500 fs-18 mb-5px">Construction</span>
                        <p class="text-light-opacity">Reliable RCC and masonry.</p>
                    </div>
                    <div class="feature-box-overlay bg-base-color"></div>
                </div>
            </div>
            <div class="col icon-with-text-style-04 transition-inner-all">
                <div class="feature-box hover-box transition dark-hover bg-white border-radius-6px pt-17 pb-17 ps-14 pe-14 last-paragraph-no-margin box-shadow-quadruple-large box-shadow-hover overflow-hidden">
                    <div class="feature-box-icon">
                        <i class="ti-ruler-alt text-base-color icon-extra-large text-light-opacity mb-20px"></i>
                    </div>
                    <div class="feature-box-content">
                        <span class="d-inline-block alt-font text-dark-gray fw-500 fs-18 mb-5px">Renovation</span>
                        <p class="text-light-opacity">Interior and exterior upgrades.</p>
                    </div>
                    <div class="feature-box-overlay bg-base-color"></div>
                </div>
            </div>
        ...
        <div class="row row-cols-1 row-cols-lg-3 row-cols-sm-2 align-items-center justify-content-center mt-6 xs-mt-8">
            <div class="col border-end xs-border-end-0 border-color-transparent-dark-very-light md-mb-35px">
                <div class="d-flex align-items-center justify-content-center">
                    <div class="flex-shrink-0 me-25px sm-me-15px">
                        <h2 class="mb-0 text-dark-gray fw-700 ls-minus-2px">4.92</h2>
                    </div>
            ...
            <div class="col">
                <div class="d-flex align-items-center justify-content-center">
                    <div class="flex-shrink-0 me-25px sm-me-15px">
                        <h2 class="mb-0 text-dark-gray fw-700 ls-minus-2px">100<sup class="fs-30">+</sup></h2>
                    </div>
                    <div class="text-dark-gray">
                        <span class="fs-17 lh-26 d-block fw-500">Civil projects completed.</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center mb-7 sm-mb-40px">
            <div class="col-xl-5 col-lg-6 col-md-10 md-mb-50px">
                ...
                <h3 class="fw-600 text-dark-gray ls-minus-2px alt-font">Benefits of our Civil Works.</h3>
                <div class="icon-with-text-style-08 mb-10px">
                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                        ...
                        <div class="feature-box-content">
                            <span class="text-dark-gray">100+ civil construction and maintenance projects completed.</span>
                        </div>
                    </div>
                </div>
                <div class="icon-with-text-style-08 mb-10px">
                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                        ...
                        <div class="feature-box-content">
                            <span class="text-dark-gray">Turnkey civil construction project execution.</span>
                        </div>
                    </div>
                </div>
                <div class="icon-with-text-style-08">
                    <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                        ...
                        <div class="feature-box-content">
                            <span class="text-dark-gray">Renovation, repair, and retrofitting services.</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="atropos-scale">
                        <div class="atropos-rotate">
                            <div class="atropos-inner">
                                <img src="{{ asset('images/civilwork.png') }}" alt="Civil Works" class="border-radius-6px" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center mt-8 sm-mt-40px">
            <div class="col-12">
                <div class="bg-solitude-blue p-9 md-p-6 xs-p-9 border-radius-6px overflow-hidden position-relative">
                    ...
                    <div class="accordion accordion-style-02" id="accordion-civilwork" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                        <div class="accordion-item active-accordion">
                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#acc-civilwork-01" aria-expanded="true" data-bs-parent="#accordion-civilwork" aria-label="accordion">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                        <i class="feather icon-feather-minus fs-20"></i><span class="fw-500">What types of civil works do you undertake?</span>
                                    </div>
                                </a>
                            </div>
                            <div id="acc-civilwork-01" class="accordion-collapse collapse show" data-bs-parent="#accordion-civilwork">
                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                    <p class="w-90 sm-w-95 xs-w-100">We undertake RCC construction, flooring and tiling, plumbing and drainage, painting, false ceiling, external development, road and compound wall construction, and all types of civil repair and renovation works.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div class="accordion-header border-bottom border-color-transparent-dark-very-light">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#acc-civilwork-02" aria-expanded="false" data-bs-parent="#accordion-civilwork" aria-label="accordion">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                        <i class="feather icon-feather-plus fs-20"></i><span class="fw-500">Do you offer end-to-end project management?</span>
                                    </div>
                                </a>
                            </div>
                            <div id="acc-civilwork-02" class="accordion-collapse collapse" data-bs-parent="#accordion-civilwork">
                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                                    <p class="w-90 sm-w-95 xs-w-100">Yes, we provide turnkey civil project management from design coordination, procurement, and construction to final handover, ensuring quality and timeline compliance.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div class="accordion-header border-bottom border-color-transparent">
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#acc-civilwork-03" aria-expanded="false" data-bs-parent="#accordion-civilwork" aria-label="accordion">
                                    <div class="accordion-title mb-0 position-relative text-dark-gray pe-30px">
                                        <i class="feather icon-feather-plus fs-20"></i><span class="fw-500">In which locations do you operate for civil works?</span>
                                    </div>
                                </a>
                            </div>
                            <div id="acc-civilwork-03" class="accordion-collapse collapse" data-bs-parent="#accordion-civilwork">
                                <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent">
                                    <p class="w-90 sm-w-95 xs-w-100">We operate across all major cities and districts of Maharashtra including Mumbai, Pune, Nashik, Nagpur, Aurangabad, and Thane for both private and government civil projects.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center">
            ...
            <div class="col">
                <div class="box-shadow-quadruple-large services-box-style-01 hover-box md-mb-30px border-radius-5px overflow-hidden">
                    <div class="position-relative box-image">
                        <img src="{{ asset('images/civil.png') }}" alt="Civil Engineering Manpower">
                        <div class="box-overlay bg-dark-gray"></div>
                        <a href="{{ route('frontend.services.civil') }}" class="d-flex justify-content-center align-items-center mx-auto icon-box absolute-middle-center z-index-1 w-60px h-60px rounded-circle box-shadow-quadruple-large border border-2 border-color-white"><i class="feather icon-feather-arrow-right text-white icon-extra-medium"></i></a>
                    </div>
                    <div class="p-10 bg-white last-paragraph-no-margin text-center">
    ...
    <div class="container">
        <div class="row align-items-center text-center text-md-start">
            <div class="col sm-mb-20px">
                <h4 class="alt-font text-dark-gray fw-600 ls-minus-2px m-0">Get a free consultation for Civil Works?</h4>
            </div>
